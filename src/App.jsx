...
import SpotBlock         from './pages/driver/SpotBlock';
import Bills             from './pages/driver/Bills';
    ...
    <ThemeProvider>
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/driver/spot-block"        element={<ProtectedRoute allowedRole="DRIVER"><SpotBlock /></ProtectedRoute>} />
          ...
          <Route path="/driver/payment/subscription/:subscriptionId" element={<ProtectedRoute allowedRole="DRIVER"><PaymentPage /></ProtectedRoute>} />
          <Route path="/driver/bills"             element={<ProtectedRoute allowedRole="DRIVER"><Bills /></ProtectedRoute>} />
          ...
          <Route path="/driver/profile"           element={<ProtectedRoute allowedRole="DRIVER"><ProfilePage /></ProtectedRoute>} />
          <Route path="/driver/help"              element={<ProtectedRoute allowedRole="DRIVER"><Help /></ProtectedRoute>} />
          ...
          <Route path="/manager/subscriptions"         element={<ProtectedRoute allowedRole="LOT_MANAGER"><SubscriptionRequests /></ProtectedRoute>} />
          <Route path="/manager/notifications"         element={<ProtectedRoute allowedRole="LOT_MANAGER"><NotificationsPage /></ProtectedRoute>} />
          <Route path="/manager/profile"               element={<ProtectedRoute allowedRole="LOT_MANAGER"><ProfilePage /></ProtectedRoute>} />
          <Route path="/manager/help"                  element={<ProtectedRoute allowedRole="LOT_MANAGER"><Help /></ProtectedRoute>} />
